...
セキュリティ監査の結果、深刻なSQL Injection脆弱性が発見されました。開発チームの一員として、GitHub Copilotを活用してこの脆弱性を適切に修正し、プリペアードステートメントを使用した安全な実装に変更する必要があります。
...
![脆弱なコードの選択](images/vulnerable-code-selection.png)

### 2.2 インラインChatを起動

**`Ctrl + I`** でインラインChatを開き、Copilotのインライン修正画面が表示されることを確認します。

![alt text](images/in-line-chat.png)
